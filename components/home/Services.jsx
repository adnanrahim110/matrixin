        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span className="btn-dot-inner absolute right-0 top-[calc(50%-0.2rem)] block h-[0.4rem] w-[0.4rem] rotate-45 rounded-[0.1rem] bg-yellow transition-colors duration-600 ease-ease" />
              </span>
            </a>
          </div>
        </div>
